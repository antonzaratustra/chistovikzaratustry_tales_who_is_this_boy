...
const NARRATION_TEXT = [
    ...
    { t: 781, text: "а каждый проходит через это по-особенному." },
    ...
    { t: 935, text: "он будет пробрать их взглядом" },
    ...
    { t: 998, text: "Ему всегда было весело с своим собой." },
    ...
    { t: 1225, text: "пока-то тебя наконец не дойдет," },
