...
function updateSubtitles(t, isJump = false) {
    ...
    if (newIndex !== -1) {
        ...
        if (newText !== currentSubtitle) {
            ...
            // Парсим текст на обычные и акцентные символы
            const parseText = (text) => {
                ...
                for (let i = 0; i < text.length; i++) {
                    ...
                    result.push({ char: text[i], accent: isAccent });
                }
                return result;
            };
            ...
            const setInstantText = () => {
                ...
                if (newText) {
                    ...
                    parsed.forEach(item => {
                        ...
                        span.className = "char" + (item.accent ? " accent" : "");
                ...
                gsap.to(container, { 
                    ...
                    onComplete: () => {
                        ...
                        if (newText) {
                            ...
                            const stagger = totalPrintDuration / parsed.length;
